...
export * from './framework/components/collision/constants.js';
export { Trigger } from './framework/components/collision/trigger.js';
export * from './framework/components/collision/backends/index.js';
export { CollisionComponentData } from './framework/components/collision/data.js';
...
export { MultiBodyComponentSystem, MultiBodySetup } from './framework/components/multibody/system.js';
...
export { PhysicsComponentData } from './framework/components/physics/data.js';
